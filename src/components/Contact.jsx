    ...
    <>
     <div className="container">
        ...
        <h1 className="text-5xl font-bold max-[470px]:text-4xl">Let's Get Started</h1>
          ...
          <a className="callToAction w-max h-max flex items-center gap-3 px-5" target="_blank" href="https://t.me/contactihsan"><i class="fa-brands fa-telegram text-[52px] absolute border -top-1 -left-1 text-sky-600 bg-zinc-50 rounded-full"></i> <span className="pl-9 ">Hello Daniel 👋🏻</span></a>
        </div>
