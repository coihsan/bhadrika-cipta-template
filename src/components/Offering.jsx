    ...
    <div className="section m-auto">
      <div className="container">
        ...
        <div className="grid grid-cols-2 gap-5 w-full">
          <div className="relative w-full border border-zinc-700 bg-gradient-to-tl from-zinc-900 to-zinc-950 p-10 rounded-md hover:border-zinc-200 transition-colors">
