...
import landingPagesServices from '../Pages/landing-pages-services.jsx'
function Offering(){
    ...
    <div className="section m-auto max-[600px]:w-full">
      <div className="container">
        ...
        <div className="grid grid-cols-2 max-[600px]:grid-cols-1 gap-3 w-full">
          <a href={'landingPagesServices'} className="cards shrink-0 basis-96 relative w-full border border-zinc-700 bg-gradient-to-tl from-zinc-900 to-zinc-950 p-10 rounded-md hover:border-zinc-200 transition-colors">
