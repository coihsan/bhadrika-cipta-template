      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 gap-3 max-[600px]:grid-cols-1">
          ...
          <div className="relative rounded-md overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 rounded-t-md flex items-center gap-2 p-2 backdrop-blur-md backdrop-opacity-60 ">
              <a className="hover:text-indigo-500 text-sm flex items-center gap-2" href="#"><img className="w-4" src={github} alt=""/>Get Code</a>
          ...
          <div className="absolute bottom-0 right-0 rounded-t-md flex items-center gap-2 backdrop-blur-md backdrop-opacity-60 p-2">
