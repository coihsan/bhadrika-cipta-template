  ...
  return(
    <div className="section m-auto aboutme">
      <div className="mb-[130px] w-full h-px bg-zinc-800"></div>
        ...
        <br/>
        <p className="">See all my badges on <a className="text-sky-400" target="_blank" href="#">Accredible <i className="fa-solid fa-arrow-up-right-from-square text-zinc-400"></i></a></p> 
        </div>
        </div>
