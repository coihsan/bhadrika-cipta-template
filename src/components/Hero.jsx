  ...
  return(
    <div className="hero-section section flex items-center w-full ">
      <div className="hero-container container flex flex-col justify-center">
        <p className="Hello max-[470px]:text-4xl max-[470px]:text-3xl">Hi there, I'm <span className="text-color">Ihsan </span>👋🏻</p>
        <p className="Hello max-[470px]:text-4xl max-[470px]:text-3xl">Digital Marketing <span className="text-color">&amp; {'{Front-End Dev}'}</span></p>
